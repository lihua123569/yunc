	...
	$("body").on("click",".setb-btn",function(){
		...
		function a(){
			$.ajax({
				type: 'POST',
				url:"/jiugongge/json/delete?id="+_dataid,
				async: false,
				success:function(result){
					result = eval("("+result+")");
					if(result.responseCode =="0000"){
	...
	$("#add_video").click(function(){
		window.location.href="/jiugongge/addJiugongge";
	});
